...
public class JniBuilder {
	...
	public static class Analog {
		 ...
		 * 
		 * @param channels
		 *            - The number of channels (dimensions) of the analog. This
		 *            is 1 for a slider, 2 for a 2D input, or 3 for a 3D input
		 * @throws IllegalArgumentException
		 *             - Thrown if {@code channels} < 0
		 */
		private void setChannels(int channels) {
			if (channels < 0)
				throw new IllegalArgumentException(
						"Analog must have 0 or more channels: Was " + channels);
		...
		public String toString() {
			return String.format("%s (%d channel analog)", this.getName(),
					this.getChannels());
		}
	}
	...
	public static class Button {
		...
		/**
		 * Initializes a new instance of the Button class with the given button
		 * name.
		 * 
		 * @param name
		 *            - the name to be given to this button.
		 */
		...
		/**
		 * Initializes a new instance of the Button class with an auto-generated
		 * name.
		 */
		public Button() {
			this(null);
	...
	public void add(Analog... analogs) {
		if (this.jni != null)
			throw new IllegalStateException(
					"Cannot alter builder after JNI has been instantiated");
	 ...
	 * layer has been instantiated from the builder)
	 * 
	 * @return
	 */
