...
/*
 * This is a Java server implementation.  It has as members a vrpn_Button_Server
 ...
 * the sole purpose of testing.  All data from the Java is represented here
...
public:
	...
	vrpn_Java_Server(vrpn_int32 num_analogs, vrpn_int32 * analog_sizes, vrpn_int32 num_buttons, vrpn_int32 port);
